    ...
    >
      ...
      >
        <div className="flex flex-row justify-end bg-transparent p-4">
          <button
            onClick={hideModal}
            className="grid h-[50px] w-[50px] place-items-center rounded-full p-3 transition-all duration-300 hover:bg-gray-200 hover:text-accent dark:text-white dark:hover:bg-secondary"
          >
