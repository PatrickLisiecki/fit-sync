...
export default function DashboardFooter({ isExpanded }) {
  ...
  return (
    <>
      ...
      >
        <div className="w-full container mx-auto flex flex-row justify-center text-[12px] sm:text-[16px]">
          ...
          {/* <ul className="hidden xs:flex flex-row gap-x-2">
            ...
            |{" "}
            <li>
              <button onClick={showModal} className="hover:text-accent transition-all duration-300">
                Report an Issue
              </button>
            </li>
          </ul> */}
