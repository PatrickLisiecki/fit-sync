    ...
    <>
      ...
      <div className="container mx-auto py-8 flex flex-wrap">
        ...
        <div className="w-full lg:w-1/2 p-4">
          ...
          <p className="mb-4">
            FlexFusion was founded in 2023 by 4 college students - Patrick
          ...
          <p className="mb-4">
            ...
            skills in programming, design, and fitness training, they built
            FlexFusion from the ground up.
          </p>

          <h2 className="text-2xl font-semibold mb-4">Our Mission</h2>
          <p className="mb-4">
            FlexFusion&apos;s mission is to empower people to reach their
          ...
          <p className="mb-4">
            ...
            and backend development. Patrick and Nicolas focused some more on
            frontend development while Andro and John had a focus toward backend
            development.
          </p>
        </div>
      </div>
